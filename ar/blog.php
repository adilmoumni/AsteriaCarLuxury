...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top">
        ...
        <div class="collapse navbar-collapse flex-column " id="navbar">
            ...
            <ul class="navbar-nav  w-100 justify-content-end px-3">
                ...
                <li class="nav-item ">
                    <a class="nav-link active" href="blog.php">مدونة <span class="sr-only"></a>
                </li>
                <li class="nav-item ">
    ...
    <h2 class="text-center mt-0">مدونتنا </h2>
    ...
    if ($result->num_rows > 0) {
        ...
        <div class="row justify-content-center" style="margin: 0px; margin-bottom : 30px;">
            <div class="col-md-8  ">
                <div class="card mt-4">
                    <img class="card-img-top img-fluid" src="../admin/blog/' . $row['Image'] . '" style"max-height:100px;" alt="">
                    <div class="card-body">
                        <h3 class="card-title">' . $row["Titre"] . '</h3>
                        <h6>' . substr($row["DateCreation"], 0, 10) . '</h6>
    ...
    <script>
        ...
        m = n.getMonth() + 1;
        d = n.getDate();
        document.getElementById("date").innerHTML = "Copyright ©" + y + "    ASTERIA CAR LUXURY - جميع الحقوق محفوظة.";
    </script>
