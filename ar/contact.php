        ...
        <div class="row justify-content-center" style="margin: 0px;">
            <div class="col-10">
                <div class="row" style="text-align: right;">
                    <div class="col-md-6">
                        <label for="firstName">الكنية :</label>
                        <input type="text" name="nom" id="inputEmail" class="form-control" placeholder="Last name " required="" autofocus="">
                    </div>
                    <div class="col-md-6">
                        <label for="firstName">الاسم الاول :</label>
                        <input type="text" name="prenom"  id="inputEmail" class="form-control" placeholder="First name " required="" autofocus="">
                    </div>
                </div>
                <div class="row" style="text-align: right;">
                    <div class="col-md-6">
                        <label for="firstName">البريد الإلكتروني :</label>
                        <input type="email" name="email" id="inputEmail" class="form-control" placeholder="example@gmail.com" required="" autofocus="">
                    </div>
                    <div class="col-md-6">
                        <label for="firstName">هاتف :</label>
                        <input type="text" name="phone"  id="inputEmail" class="form-control" placeholder="06 33 66 66 44" required="" autofocus="">
                    </div>
                </div>
                <div class="row" style="text-align: right;">
                    <div class="col-md-12">
                        <label for="firstName" style="text-align: right;"> : رسالة </label>
                        <textarea name="message" class="form-control"> </textarea>
                    </div>
                </div>
                <div class="row justify-content-center" style="margin-top:20px;">
                <input  class="btn btn-light btn-xl js-scroll-trigger" type="submit" value="الحجز" />
