                ...
                <div class="col-md-10">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input required type="text" id="fullName" name="fullName" value="" class="form-control" placeholder="Full Name" autofocus="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label for="firstName">Pick up location :</label>
