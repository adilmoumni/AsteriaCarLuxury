...
<body class="bg-dark">
    ...
    <div class="d-flex flex-row p-2 justify-content-between kd-on" style="background-color: white;">
        ...
        <div class="p-2 kd-on">
            ...
            <img height="30px" src="assets/img/espagne.png" />
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top">
        ...
        <div class="collapse navbar-collapse flex-column " id="navbar">
            ...
            <ul class="navbar-nav  w-100 justify-content-end px-3">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="#">Modèles <span class="sr-only">span></a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link" href="#">Condition générales <span class="sr-only">span></a>
                </li>
                <li class="nav-item ">
        ...
        <form class="col-md-12 justify-content-center text-center" action="process.php" method="POST">
            ...
            <div class="row justify-content-center" style="margin-left: 20px; margin-right: 20px;">
                ...
                <div class="col-md-10">
                    <div class="row">
                        <div class="col-md-4">
                            <label for="firstName">Nom & Prenom:</label>
                            <input required type="text" id="fullName" name="fullName" value="" class="form-control" placeholder="Nom & Prenom" autofocus="">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input required type="text" value="<?php echo $txtAdresseDepartGet ?> " id="lieuLivraison" name="lieuLivraison" class="form-control" placeholder="Lieu de livraison" autofocus="">
                        </div>
                        <div class="col-md-6">
                            <label for="firstName">Lieu de récuperation :</label>
                            <input required type="text" id="lieuRecuperation" value="<?php echo $txtAdresseArriverGet ?> " name="lieuRecuperation" class="form-control" placeholder="Lieu de récuperation" autofocus="">
                        </div>

                        <div class="col-md-6">
                            <label for="firstName">Du :</label>
